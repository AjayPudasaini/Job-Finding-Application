# Generated by Django 3.0.9 on 2020-08-16 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Twitter', models.URLField(max_length=100)),
                ('Instagram', models.URLField(max_length=100)),
                ('UploadCv', models.FileField(null=True, upload_to='Jobseeker/CVs', verbose_name='Upload Your CV')),
                ('MySkill', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='My Skill')),
            ],
        ),
    ]
